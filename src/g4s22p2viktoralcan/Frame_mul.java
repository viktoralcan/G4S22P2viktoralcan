...
public class Frame_mul extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(222, 247, 241));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frame_mul.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
